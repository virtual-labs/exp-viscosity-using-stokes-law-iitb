...
{
    question = [];
    question.push({ srno: 1, question: "Select <span style='color: #018fc3'>Glass Column</span>", ans: "glass_column", hint: ["Has Suction and Discharge", "Has valve attached", "Triangular Base"] });
    question.push({ srno: 2, question: "Select <span style='color: #018fc3'> Steel Ball </span>", ans: "steel_ball", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    question.push({ srno: 3, question: "Select <span style='color: #018fc3'> Timer </span>", ans: "timer", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
}
